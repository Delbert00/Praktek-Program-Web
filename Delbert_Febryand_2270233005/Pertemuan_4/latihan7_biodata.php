...
<body>
    ...
    echo "<h1>BIO DATA</h1>";
    echo "<table width='60%'>";
    echo "<tr><td class='atas' width='30%'>Nama :</td><td width='30%'><input type='text' name='name' value='Delbert Febryand Lubis'></td></tr>";
    echo "<tr><td class='atas'>NIM :</td><td><input type='text' name='name' value='2270233005'></td></tr>";
    ...
    echo "<tr><td class='atas'>Foto :</td><td><img src='delbert.JPG' width='200px'></img></td></tr>";
